...
<div style="width:1200; margin-left:auto; margin-right:auto; background-color:white">
	...
	<div style="width:1200; height:300;">
		<br>
		<a class="HomeHonorAll" href="Honor" style="float:right; position:relative; left:-60">查看全部</a>
		<br>
		<div class="ImageScroll" >
   			<div class="ImageViewContainer">
   				<%for (int i = 0; i < allHonor.getList().size(); i++) 
				{%>
					<img class="ImageView"  id="<%=allHonor.getList().get(i).getHonor_id() %>" name="<%=i%>" src="<%=allHonor.getList().get(i).getPicture()[0] %>" onmousemove="changeImg(this)" onmouseout="leaveImg(this)" onclick="linkToImg(this)">
					<%
